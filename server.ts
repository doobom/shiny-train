...
CREATE TABLE IF NOT EXISTS "promo_codes" (
    ...
    try {
      await db.execute(sql.raw(`ALTER TABLE addresses ADD COLUMN remark text`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE users ADD COLUMN avatar_url text`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE discounts ADD COLUMN name_zh text`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE discounts ADD COLUMN name_en text`)).catch(()=>{});
      
      await db.execute(sql.raw(`ALTER TABLE users ADD COLUMN IF NOT EXISTS role VARCHAR(50) DEFAULT 'customer'`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE users ADD COLUMN IF NOT EXISTS permissions JSONB`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE users ADD COLUMN IF NOT EXISTS tier VARCHAR(50) DEFAULT 'standard'`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE users ADD COLUMN IF NOT EXISTS locale VARCHAR(20) DEFAULT 'zh-HK'`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE users ADD COLUMN IF NOT EXISTS status VARCHAR(20) DEFAULT 'active'`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE users ADD COLUMN IF NOT EXISTS phone_encrypted VARCHAR(255)`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE users ADD COLUMN IF NOT EXISTS avatar_url VARCHAR(255)`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE products ADD COLUMN IF NOT EXISTS images JSONB DEFAULT '[]'`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE banners ADD COLUMN IF NOT EXISTS link_url VARCHAR(255)`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE banners ADD COLUMN IF NOT EXISTS disabled BOOLEAN DEFAULT FALSE`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE roles ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT now()`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE carts ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT now()`)).catch(()=>{});
      await db.execute(sql.raw(`ALTER TABLE discounts ADD COLUMN IF NOT EXISTS name_zh VARCHAR(255)`)).catch(()=>{});
    } catch(e) {
